...
public class RestClient
{
    ...
    {
        this.logger = configuration.LoggerProvider.CreateLogger(nameof(RestClient));
    ...
    private async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request)
    {
        ...
        logger.LogDebug("[{Method}] {Url} -> {StatusCode}", request.Method, request.RequestUri, response.StatusCode);
        return response;
    }
